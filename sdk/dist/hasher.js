...
class UsernameHasher {
    ...
    hashRaw(username) {
        ...
        for (let i = 0; i < 2; i++) {
            const j = i * 4;
            h2[i] = F.toObject(this.poseidon([h[j + 0], h[j + 1], h[j + 2], h[j + 3]]));
        }
        // Step 3: Final hash
...
exports.UsernameHasher = UsernameHasher;
