...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-0 -mb-0 flex flex-col-reverse gap-2 rounded-none border-t border-white/15 bg-transparent p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
